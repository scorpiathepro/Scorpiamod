...
public class NetheriteDetectorItem extends Item {
    public NetheriteDetectorItem(Properties pProperties) {
        super(pProperties);
    }
    @Override
    ...
    private void outputValuableCoordinates(BlockPos blockPos, Player player, Block blockBelow) {
        player.sendSystemMessage(Component.literal("Found " + "Netherite Scrap" + " at " +
                "(" + blockPos.getX() + ", " + blockPos.getY() + "," + blockPos.getZ() + ")"));
    }

    private boolean isValuableBlock(Block block) {
        return block == Blocks.ANCIENT_DEBRIS || block == Blocks.NETHERITE_BLOCK;
    }
}
