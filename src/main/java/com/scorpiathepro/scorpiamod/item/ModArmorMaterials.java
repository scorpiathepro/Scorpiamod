...
public enum ModArmorMaterials implements ArmorMaterial {
    DRAGON("dragon", 37, new int[]{3, 6, 8, 3}, 15, SoundEvents.ARMOR_EQUIP_NETHERITE,
            3.0F, 0.1F, () ->Ingredient.of(ModItems.Dragon_Shell.get()));
    ...
    public String getName() {
        return ScorpiaMod.MOD_ID + ":" + this.name;
    }
